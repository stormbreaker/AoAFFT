...
void calcQ(complex<double> y[], complex<double> omegas[], complex<double> a[], int n, int it, double ttl[])
  ...
  * Name: findMaxes
  * Author: Benjamin Kaiser
  * Description: This function finds the top 5 peaks.  This was written from
  *	Dr. Logar's notes.  Goes through and adds two points from either side.
  * Then it finds the max values in it.
  * Parameters:
